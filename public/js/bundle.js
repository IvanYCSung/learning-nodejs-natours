...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaXZhbnljc3VuZyIsImEiOiJjbGo1aGRra3kwYW12M2dtbWJ2ZHRmOHIzIn0.sOZWh1VkJpMvTyrZNf2gyQ';
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            ...
            window.setTimeout(function () {
              location.assign('/');
            }, 1500); // reload and redirect to home page in 1.5 sec after logging in successfully
          }
          _context.next = 10;
          break;
        case 7:
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          // location.reload(true) reloads the page after logging out
          _context2.next = 10;
          break;
        case 7:
          _context2.prev = 7;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /*eslint-disable*/
var stripe = Stripe('pk_test_51NQRBzDkOYfi1vJpMyyDTX7ZD6juRn9azyEvvzLLMcWE2CW6ZE6xNNrgLCRx1YxsizVqebVm9K97B8mQOlGFQn4X006RQKVFiD'); // FRONTEND MODE - Stripe(public key)
...
if (mapBox) {
  ...
  // use dataset to access the data in data- attributes
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData(); // creating multi form data for uploading all types of data, especially files
